...
static int detect_yolov8(const cv::Mat& bgr, std::vector<Object>& objects)
{
	...
	if (yolov8.load_param("/home/wangshuai/WS/ws_test/ncnn-examples-main/cpp/yolov8/build/model/yolov8s.ncnn.param"))
		exit(-1);
	if (yolov8.load_model("/home/wangshuai/WS/ws_test/ncnn-examples-main/cpp/yolov8/build/model/yolov8s.ncnn.bin"))
		exit(-1);
...
static void draw_objects(const cv::Mat& bgr, const std::vector<Object>& objects)
{
    ...
    cv::imwrite("/home/wangshuai/WS/new_kl/kl_ncnn_yolov5/img_dir/image.jpg",image);
...
int main(int argc, char** argv)
{
    ...
    printf("detect_yolov8 has been ok !");
